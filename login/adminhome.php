  ...
  <div class="collapse navbar-collapse" id="G-97 Saving">
    <ul class="navbar-nav mr-auto mt-0 mt-lg-0">
      <li class="nav-item active">
        <a class="nav-link" href="/saving/Login/adminhome.php">Home</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/saving/details/adetails.php">Member Details</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/saving/loan/loan.php">Loan</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/saving/dep/dep.php">Deposit</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/saving/stmt/astatement.php">Statement</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="/saving/lc/alc.php">Loan Calculation</a>
      </li>
    </ul>
    <div class="wrapper"><!--!-->
  ...
  <div class="card card-primary animate__animated animate__fadeIn">
    <div class="card-body box-profile">
            <ul class="list-group list-group-unbordered mb-3"><li class="list-group-item"><!--!-->
                ...
                <li class="list-group-item"><!--!-->
                Password<span class="float-right"><?php echo '**********'; ?><div class="left"><a href="/saving/login/acp.php" class="btn btn-default btn-flat">Change Password</a></div>
                      </span></li><!--!-->
        </app>
